...
Auto-generated client library for accessing the prediction v1.2 API.
...
```
  dependencies:
    google_prediction_v1_2_api: '>=0.4.12'
```

For web applications:

```
  import "package:google_prediction_v1_2_api/prediction_v1_2_api_browser.dart" as predictionclient;
```

For console application:

```
  import "package:google_prediction_v1_2_api/prediction_v1_2_api_console.dart" as predictionclient;
```
